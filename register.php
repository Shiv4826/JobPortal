...
if($validate->rowCount() >0){ 
  ...
  $insert=$conn->prepare("INSERT INTO users (username, email, mypassword, img, type,id) Values (:username,:email, :mypassword, :img, :type,:id)");
...
header("location:login.php");
      ...
      //14:18 in Register Page
      echo "<script>alert('password are note matching')</script>"; 
    }
